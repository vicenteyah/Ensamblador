...
DOS:
       ...
       JMP SUMA
UNO:
       MOV AH,00		;Acomodamos el primer valor
       MOV AL,VALOR[2]
       MOV BH,00
       MOV BL,00
       JMP SUMA
...
DIFERENTES:
       ...
       JMP SUMA2
TRES2:
       MOV DH,VALOR2[3]		;Acomodamos el segundo valor
       MOV DL,VALOR2[4]
       MOV CH,00
       MOV CL,VALOR2[2]
       JMP SUMA2
...
DOS2:
       MOV DH,VALOR2[2]		;Acomodamos el segundo valor
       MOV DL,VALOR2[3]
       MOV CH,00
       MOV CL,00
       JMP SUMA2
UNO2:
       MOV DH,00		;Acomodamos el segundo valor
       MOV DL,VALOR2[2]
       MOV CH,00
       MOV CL,00
       JMP SUMA2
